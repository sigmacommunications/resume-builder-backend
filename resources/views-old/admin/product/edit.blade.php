      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="availbleColor[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="red"  @if( in_array( "red",$data ) ) selected @endif>red</option>
              <option value="pink"  @if( in_array( "pink",$data ) ) selected @endif>pink</option>
              <option value="green"  @if( in_array( "green",$data ) ) selected @endif>green</option>
              <option value="yellow"  @if( in_array( "yellow",$data ) ) selected @endif>yellow</option>
              <option value="brown"  @if( in_array( "brown",$data ) ) selected @endif>brown</option>
              <option value="white"  @if( in_array( "white",$data ) ) selected @endif>white</option>
              <option value="orange"  @if( in_array( "orange",$data ) ) selected @endif>orange</option>
              <option value="blue"  @if( in_array( "blue",$data ) ) selected @endif>blue</option>
              <option value="purple"  @if( in_array( "purple",$data ) ) selected @endif>purple</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
