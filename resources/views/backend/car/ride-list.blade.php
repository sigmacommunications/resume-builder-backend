...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Ride History</h6>
          ...
          <tbody>
            ...
            @foreach($rides as $car)
                <tr>
                    ...
                    <td>
                        @if($car->status=='confirm')
                        <span class="badge badge-primary">{{$car->status}}</span>
                        @elseif($car->status=='cancel')
                        <span class="badge badge-warning">{{$car->status}}</span>
                        @elseif($car->status=='complete')
                        <span class="badge badge-success">{{$car->status}}</span>
                        @elseif($car->status=='reject')
                        <span class="badge badge-danger">{{$car->status}}</span>
                        @endif
                    </td>
                    <td>
